...
This project-specific skill is active at `.agents/skills/quantamorph-cinematic-design`. Do not install it globally or duplicate it in another skill location.
